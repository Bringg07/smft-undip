      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl font-body text-sm leading-7 text-perlemen-300">
            Struktur kepengurusan Senat Mahasiswa Fakultas Teknik UNDIP — Kabinet Langkah Karya.
          </p>
        </motion.div>

        {pengurus.length === 0 ? (
          <p className="py-16 text-center font-body text-white/50">
            Belum ada data pengurus. Silakan kembali lagi nanti.
          </p>
        ) : (
            ...
            {pengurus.map((leader, i) => (
              ...
              >
                ...
                <div className="mt-6 text-center">
                  ...
                  <p className="mt-2 font-body text-sm text-perlemen-300">{leader.jabatan}</p>
                </div>
